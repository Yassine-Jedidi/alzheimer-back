...
def predict_alzheimer(audio_path, model_path='alzheimer_back/api/alzheimer_model.h5',
                      scaler_path='alzheimer_back/api/alzheimer_scaler.pkl',
                      labels_path='alzheimer_back/api/alzheimer_labels.npy'):
    """
